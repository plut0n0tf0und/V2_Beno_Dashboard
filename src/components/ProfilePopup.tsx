  ...
  return (
    <div ref={ref} className="relative">
      ...
      <AnimatePresence>
        {open && (
          <>
            <div className="fixed inset-0 z-[90] sm:hidden" onClick={() => setOpen(false)} aria-hidden="true" />
            <motion.div
              role="menu"
            ...
            >
              ...
              <div className="px-4 py-4 border-b border-on-surface-variant/8 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full overflow-hidden border border-on-surface-variant/20 flex-shrink-0">
                  <img src="https://picsum.photos/seed/user/100/100" alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" aria-hidden="true" />
                </div>
              ...
              <div className="px-4 py-3 border-b border-on-surface-variant/8">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    {isDarkMode ? <Moon className="w-4 h-4 text-on-surface-variant" aria-hidden="true" /> : <Sun className="w-4 h-4 text-on-surface-variant" aria-hidden="true" />}
                  ...
                  >
                    <span className="sr-only">{isDarkMode ? 'Dark mode on' : 'Light mode on'}</span>
                    <div className={`absolute top-0.5 w-5 h-5 rounded-full bg-surface shadow-sm transition-transform duration-300 ${isDarkMode ? 'translate-x-5' : 'translate-x-0.5'}`} aria-hidden="true" />
                  </button>
                </div>
              </div>
              ...
              {/* Menu items */}
              <div className="p-1.5">
                <button role="menuitem" className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold text-on-surface hover:bg-surface-container-high transition-colors">
                  <User className="w-4 h-4 text-on-surface-variant" aria-hidden="true" />
                  Account
                </button>
                <button role="menuitem" className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold text-on-surface hover:bg-surface-container-high transition-colors">
                  <Settings className="w-4 h-4 text-on-surface-variant" aria-hidden="true" />
                  Settings
                </button>
                <button role="menuitem" className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold text-red-400 hover:bg-red-400/10 transition-colors">
